...
class ContextFactory {
	constructor() {
		...
		this._TEMPLATE_SERVICEBUS_TRIGGER = this._TEMPLATE_BASE_PATH + Events.TRIGGER.SERVICEBUS_TRIGGER + this._TEMPLATE_SUFFIX;
	}
	...
	createContext(metadata, args) {
		...
		switch (metadata.triggerType) {
			...
			case Events.TRIGGER.QUEUE_TRIGGER:
				...
				break;
			case Events.TRIGGER.SERVICEBUS_TRIGGER:
				console.log(this._TEMPLATE_SERVICEBUS_TRIGGER);
				context = require(this._TEMPLATE_SERVICEBUS_TRIGGER);
				break;
			default:
